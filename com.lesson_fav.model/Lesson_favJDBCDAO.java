...
public class Lesson_favJDBCDAO implements Lesson_favDAO_interface{
	...
	private static final String GET_Lessno_STMT = "SELECT STUNO FROM Lesson_fav WHERE LESSNO = ? ";
	private static final String GET_Stuno_STMT = "SELECT LESSNO FROM Lesson_fav WHERE STUNO = ?";
...
//		System.out.println("---------------------");
//		// 查詢一個學生有多少課程OK
//		List<Lesson_favVO> list1 = dao.getfindByStuno("S003");
