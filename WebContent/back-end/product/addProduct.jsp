...
<div class="table-responsive-sm table-hover table-success">
		<table class="table align-items-center">
			...
			<tr>
				<td>商品名稱</td>
				<td><input type="text" placeholder="請輸入商品名稱" name="prodname"
					size="40"
					value="<%=(productVO == null) ? "" : productVO.getProdname()%>" /></td>
			</tr>
			<tr>
				<td>商品價格</td>
				<td><input type="text" placeholder="請輸入商品價格" name="prodprice"
					size="40"
					value="<%=(productVO == null) ? "" : productVO.getProdprice()%>" /></td>
			</tr>
			<tr>
				<td>商品數量</td>
				<td><input type="text" name="prodqty" placeholder="請輸入商品數量"
					size="40"
					value="<%=(productVO == null) ? "" : productVO.getProdqty()%>" /></td>
			</tr>
			<tr>
				<td>商品狀態</td>
			...
			<tr>
				<td>商品圖片</td>
				<td><input type="file" name="prodpic" placeholder="請選擇圖片"
					value="" />
			</tr>
			<tr>
				<td>商品描述</td>
				<td><input type="text" placeholder="請輸入商品描述" name="proddesc"
					size="40"
					value="<%=(productVO == null) ? "" : productVO.getProddesc()%>" /></td>
			</tr>
			<tr>
				<td colspan="2">
