...
<!-- Title  -->
<title>活動訂單修改 - update_activityorder_input.jsp</title>
<!-- Favicon  -->
				...
				<div class="regular-page-content-wrapper section-padding-60">
					<FORM METHOD="post" ACTION="activityorder.do" name="form1">
						...
						<div class="regular-page-text">
							<h2 class="text-black">更改教練評價</h2>
							<table class="table table-dark table-hover">
								<tr>
									<td class="text-left justify-content-left">活動訂單編號:<font color=red><b>*</b></font></td>
									<td class="align-middle">${activity_orderVO.aord_no}</td>
								</tr>
								<tr>
									<td class="text-left justify-content-left">活動編號:</td>
									<td class="align-middle">${activity_orderVO.actno}</td>
								</tr>
								<tr>
									<td class="text-left justify-content-left">學員編號:</td>
									<td class="align-middle">${activity_orderVO.stuno}</td>
								</tr>
								<tr>
									<td class="text-left justify-content-left">教練評價數:</td>
									<td class="align-middle"><input type="text" name="aord_sc" size="45"
										value="${activity_orderVO.aord_sc}" placeholder="請輸入教練評價數" /></td>
								</tr>
