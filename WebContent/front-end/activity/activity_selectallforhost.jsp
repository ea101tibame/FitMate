					...
					<div class="regular-page-content-wrapper section-padding-80">
						<div class="regular-page-text">
							...
							<table border="1"
								...
								<tr>
									<td rowspan="8" style="width:480px;max-height:100%"><img
										src="<%=request.getContextPath()%>/activity/activitypic.do?actno=${activityVO.actno}"
										alt="活動圖片" class="rounded float-right img-thumbnail img-fluid"></td>
										...
										<div class="row justify-content-center align-self-center">
											...
											<FORM METHOD="post"
												...
												<button type="submit" class="btn btn-warning"
													<c:if test="${activityVO.actsta=='下架'}">value="Disabled" disabled</c:if>>下架</button>
												<input type="hidden" name="actno"
													value="${activityVO.actno}"> <input type="hidden"
													name="action" value="offactivity">
											</FORM>		
