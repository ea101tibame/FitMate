...
<link rel="icon"
	href="<%=request.getContextPath()%>/img/index-core-iamge/favicon.ico">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/core-style.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/custom-css/ListAllCoach.css">
<link
						...
						<div class="regular-page-text">
							...
							<div class="dropdown">
								<button class="btn btn-secondary dropdown-toggle" type="button"
									...
									aria-expanded="false">依專長搜尋</button>
								...
								<tbody>
									<c:forEach var="coaVO" items="${coaVOs}">
										<tr>
											...
											<td>null</td>
											<td><img
												src="<%=request.getContextPath()%>/coach/picServletJDBC.do?coano=${coaVO.coano}"
												alt="教練照片"></td>
											<td>
												<form METHOD="post"
													...
													<input type="submit" class="btn btn-outline-primary"
														value="詳情"> <input type="hidden" name="action"
														value="getOne_For_Update"> <input type="hidden"
														name="coano" value="${coaVO.coano}">
												</form>
											</td>
										</tr>
									</c:forEach>
