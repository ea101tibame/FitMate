	...
	<c:if test="${role == 'student'}">
		...
		<%--學員身 追蹤按鈕--%>	
			...
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/lesson_order/lesson_order.do" class="col-6" id="goform">
				<button  class="btn col-sm-10 col-sm-offset-1 btn-lg gogogo" type="button" style="background-color: #fb641b; color: #fff; font-size: 1em; " <c:if test='${lesssta == "下架" ||  Y}'> disabled="disabled" title="課程已下架或已購買" </c:if>   >
