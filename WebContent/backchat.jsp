...
<title>客服後台</title>
<link href="<%=request.getContextPath()%>/static/css/global.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/static/css/styles.css" rel="stylesheet">
</head>
...
<%-- 			</c:choose> --%>
		...
		<!-- 展示聊天信息 -->
		<div class="chat-bg" >
			<header class="header-title" id="title">客服後台</header>
			...
			<!-- 上传文件图片按钮 -->
			 ...
			 <!-- *********************输入聊天内容，并发送************************** -->
			 <textarea id="chatContent" rows="4" class="chat-info" placeholder="回覆客訴內容..."></textarea> <!-- <p class="chat-info" placeholder="想咨询他什么内容..." contenteditable="true"></p> -->
			 <button class="send-btn fr" id="subsend" onclick="subSend()" >送出</button>
	...
	<script src="<%=request.getContextPath()%>/static/js/chat.js"></script>
...
//     var leftImgSrc = 'http://120.76.230.93:8063/Upload/2017/0914/20170914092809690_55e736d12f2eb9384eade4fed6628535e4dd6ffe.jpg';
    var adminImgSrc = "<%=request.getContextPath()%>/static/image/test.jpg";
    
    //访客图像
//     var rightImgSrc = 'http://120.76.230.93:8063/Upload/2017/1116/20171116180954252_img.png';
    var userImgSrc ="<%=request.getContextPath()%>/static/image/test4.jpg";
