...
<%
	...
	List<ActivityVO> list = activitySvc.getAllForHost("S004");
		...
		<div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
			...
			<nav class="classy-navbar" id="essenceNav">
				...
				<a class="nav-brand" href="index.html">
					<img src="${pageContext.request.contextPath}/images/core-img/logo.png" alt="">
				</a>
				<!-- Navbar Toggler -->
						...
						<ul>
							...
							<li>
								...
								<ul class="dropdown">
									...
									<li>
										<a href="single-uct-details.html">肌力訓練</a>
									</li>
									<li>
			...
			<div class="header-meta d-flex clearfix justify-content-end">
				...
				<div class="user-login-info">
					<a href="#">
						<img src="${pageContext.request.contextPath}/images/core-img/heart.svg" alt="">
					</a>
				</div>
				<div class="user-login-info">
					<a href="#">
						<img src="${pageContext.request.contextPath}/images/core-img/user.svg" alt="">
					</a>
				</div>
				<div class="user-login-info">
					<a href="#">
						<img src="${pageContext.request.contextPath}/images/core-img/email.svg" alt="">
					</a>
				</div>
