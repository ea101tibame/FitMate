				...
				<div class="regular-page-content-wrapper section-padding-60">
					<FORM METHOD="post" ACTION="activity.do" name="form1"
						...
						<div class="regular-page-text">
							<div class="row">
								<div class="col-3">
									<label for="actno" class="text-danger"><b>*</b>活動編號</label>
								</div>
								<div class="col-5">${activityVO.actno}</div>
								<input type="hidden" name="actno" id="actno" size="36.5"
										value="${activityVO.actno}">
							</div>

							<div class="row">
								<div class="col-3">
									<label for="stuno" class="text-danger"><b>*</b>學員編號</label>
								</div>
								<div class="col-5">${activityVO.stuno}</div>
							...
							<div class="row">
								<div class="col-3">
									<label for="actprice">活動狀態</label>
								</div>
								<div class="col-5">
									<input type="TEXT" name="actsta" id="actsta" size="36.5"
