...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="activity.do" name="form1"
		...
		<table>
			<tr>
				<td>活動名稱:</td>
				<td><input type="TEXT" name="actname" size="45" value=""
					placeholder="請輸入活動名稱" /></td>
			</tr>
			<tr>
				<td>活動地點:</td>
				<td><input type="TEXT" name="actloc" size="45" value=""
					placeholder="請輸入活動地點" /></td>
			</tr>
			<tr>
				<td>活動日期:</td>
				<td><input type="DATE" name="actdate" id="f_date1"
					placeholder="請輸入活動日期"></td>
			</tr>
			<tr>
				<td>活動時段:</td>
				<td><input type="TEXT" name="actss" size="45" value=""
					placeholder="請選擇活動時段" /></td>
			</tr>
			<tr>
				<td>活動開始報名日期:</td>
				<td><input type="DATE" name="actstart" id="f_date2"
					placeholder="請輸入開始報名日期"></td>
			</tr>
			<tr>
				<td>活動截止報名日期:</td>
				<td><input type="DATE" name="actend" id="f_date3"
					placeholder="請輸入截止報名日期"></td>
			</tr>
			<tr>
				<td>活動類型:</td>
				<td><input type="TEXT" name="acttype" size="45" value=""
					placeholder="請選擇活動類型" /></td>
			</tr>
			<tr>
				<td>活動點數:</td>
				<td><input type="TEXT" name="actprice" size="45" value=""
					placeholder="請輸入活動點數" /></td>
			</tr>
			<tr>
				<td>活動最小成團人數:</td>
				<td><input type="TEXT" name="actmin" size="45"
					value="<%=(activityVO == null) ? "1" : activityVO.getActmin()%>"
					placeholder="請輸入活動最小成團人數" /></td>
			</tr>
			<tr>
				<td>活動最大上限人數:</td>
				<td><input type="TEXT" name="actmax" size="45" value=""
					placeholder="請輸入活動最大上限人數" /></td>
			</tr>
			<tr>
				<td>活動目前報名人數:</td>
				<td><input type="TEXT" name="actcur" size="45" value=""
					placeholder="請輸入活動目前報名人數" /></td>
			</tr>
			<tr>
				<td>活動描述:</td>
				<td><input type="TEXT" name="actdesc" size="45" value=""
			...
			<tr>
				<td>學員編號:</td>
				<td><input type="TEXT" name="stuno" size="45" value=""
					placeholder="請輸入您的學員編號" /></td>
			</tr>
			<tr>
				<td>教練編號:</td>
				<td><input type="TEXT" name="coano" size="45" value=""
...
<%
	// 		java.sql.Date actdate = activityVO.getActdate();
	// 		actdate = new java.sql.Date(System.currentTimeMillis());
%>
<%
	// 		java.sql.Date actstart = activityVO.getActstart();
	// 		actstart = new java.sql.Date(System.currentTimeMillis());
%>
<%
	// 		java.sql.Date actend = activityVO.getActend();
