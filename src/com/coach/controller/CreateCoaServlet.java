...
//					coaVO.setCoapic(coapic);
				...
				coaSvc.addCoa(coaname, coapsw, coamail, coatel, coaacc, new byte[2], coasex);
				/*************************** 3.新增完成,準備轉交(Send the Success view) ***********/
				String url = "/front-end/coach/listAllCoach.jsp";
...
//修改一筆教練資料
		...
		else if ("getOne_For_Update".equals(action)) { // 來自listAllCoach.jsp的請求
