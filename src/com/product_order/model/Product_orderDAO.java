...
public class Product_orderDAO implements Product_orderDAO_interface {
	...
	//INSERT INTO product_order(pordno,stuno,porddate,pordtotal,pordadd,pordsta,fare,phonenumber)VALUES(to_char(sysdate,'yyyymmdd')||'-PO'||LPAD(to_char(PRODUCT_ORDERseq.NEXTVAL), 3, '0'),?,CURRENT_TIMESTAMP,?,?,?,?,?)";
